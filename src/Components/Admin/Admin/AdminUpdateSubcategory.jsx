...
import {
  getSubcategory,
  updateSubcategory,
} from "../../../Redux/Actioncreators/SubcategoryActionCreate";
...
export default function AdminUpdateSubcategory() {
  ...
  function postData(e) {
    ...
    if (error) setShow(true);
      ...
      if (item) {
        ...
        dispatch(updateSubcategory({ ...data, id: id }));
  ...
  useEffect(() => {
    if (SubcategoryStateData.length && id) {
      const existingItem = SubcategoryStateData.find((item) => item.id == id);
      if (existingItem) {
        setData({
