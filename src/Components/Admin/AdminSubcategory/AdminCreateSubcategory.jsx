...
import {getSubcategory, createSubcategory, SubcategoryStateData} from "../../../Redux/Actioncreators/SubcategoryActionCreate"
    ...
    <>
      ...
      <div className="container-fluid my-3">
        <div className="row">
            ...
            <h5 className='bg-primary text-center p-2 text-light'><Link to="/admin/subcategory/create"><i className='fa fa-arrow-left text-light float-end'></i></Link>Subcategory</h5>
