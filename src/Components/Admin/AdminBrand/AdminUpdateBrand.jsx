...
import {
  getBrand,
  updateBrand,
} from "../../../Redux/Actioncreators/BrandActionCreate";
...
export default function AdminUpdateBrand() {
  ...
  function postData(e) {
    ...
    if (error) setShow(true);
      ...
      if (item) {
        ...
        dispatch(updateBrand({ ...data, id: id }));
  ...
  useEffect(() => {
    if (BrandStateData.length && id) {
      const existingItem = BrandStateData.find((item) => item.id == id);
      if (existingItem) {
        setData({
