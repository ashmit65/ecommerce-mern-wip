            ...
            <div className="col-xl-6 wow fadeInLeft" data-wow-delay="0.2s">
              <div className="about-item-content bg-white rounded p-5 h-100">
                ...
                <p>
                  ...
                  Beatae praesentium recusandae eligendi modi hic
                </p>
                ...
                <p className="text-dark">
                  <i className="fa fa-check text-primary me-3"></i>We can
                  deliver your order fast
                </p>
                <p className="text-dark mb-4">
                  <i className="fa fa-check text-primary me-3"></i>upto 95% OFF
                </p>
                <Link
